...
ggplot(data = line_data,
  ...
  labs(title = "Weekly Unemployment Insurance Claims in Top 5 States\nwith Highest COVID-19 Incidence Rate",
       caption = "Source: US Department of Labor & Johns Hopkins University Center for Systems Science and Engineering",
       x = "Week Ending",
  ...
  theme(plot.margin = unit(c(.5, .5, .5, .5),"cm"),
        ...
        axis.title.x = element_text(family = "Arial", vjust = -4),
        axis.title.y = element_text(family = "Arial", vjust = .5),
        axis.text.x = element_text(angle = 45, family = "Arial", vjust =-.05),
