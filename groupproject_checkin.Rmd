...
**Algorithms**: CART/RANDOM FOREST. We will have three predictive models based off of data from when the first case was reported in the US and when the first death was reported in the US.
