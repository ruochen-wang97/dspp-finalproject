...
>>>>>>> 653dfdc8101bad648028082670901312f127a993
...
```{r merge-ihme-covid-data,  echo=T, message=F, warning=F}
...
# read in JHU COVID data from Github for April 10, 2020
...
# read in JHU data on incident and mortality rates from Github for April 12, 2020
...
```{r merge-apr18-unemploy-data, echo=T, message=F, warning=F}

unemp_apr18 <- read_excel("data/raw/unemployment_bystate_w4.18.xlsx")

clean_data <-
  left_join(clean_data, unemp_apr18, by = "state")
anti_join(clean_data, unemp_apr18)
```
